...
import Tilt3DCard from "../../component/Tilt3DCard";
...
const MovieCard = ({ movie }) => {
  ...
  return (
    ...
    >
      <Tilt3DCard maxTilt={14} scale={1.04} className="h-full">
        <div className="relative block rounded-2xl overflow-hidden bg-zinc-900 border border-zinc-800 transition-colors duration-300 group-hover:border-red-600/60 flex flex-col h-full">
