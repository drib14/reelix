          ...
          {movies?.map((movie, index) => {
            ...
            return (
              <Link
                ...
                className="relative flex-shrink-0 group/card cursor-pointer ml-3"
              >
                ...
                {/* 3D Poster Card Container */}
                <Tilt3DCard maxTilt={12} scale={1.05} className="w-[150px] sm:w-[200px] h-[225px] sm:h-[300px]">
                  <div className="relative h-full w-full bg-zinc-900 border border-zinc-800 rounded-2xl overflow-hidden transition-colors duration-300 group-hover/card:border-red-600/60">
                    <img
                      src={imageSrc}
